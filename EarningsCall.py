...
# define function to parse through extracted earnings call from website
def parse_html(html):
    sleep(1)
    ...
    for header in [p.parent for p in soup.find_all('strong')]:
        ...
        if text.lower().startswith('copyright'):
            ...
            for participant in header.find_next_sibilings('p'):
...
# Define function to store parsed results into a csv file
...
# Run the transcript and parse HTML
SA_URL = 'http://seekingalpha.com/'
